...
module JavaBuildpack::Container
  ...
  class Jonas
    ...
    def release
      ...
      "#{java_home_string} #{java_opts_string} && #{export_base_vars_string} && #{if_jonas_base_exists_string} #{deployme_var_string} && #{export_deployme_vars_string} && #{topology_erb_cmd_string} && #{deployme_cmd_string} && #{linkapp_cmd}; #{else_skip_string} && #{start_script_string}"
    end
